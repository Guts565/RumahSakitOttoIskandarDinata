        ...
        <form method="POST" action="/dokter">
            ...
            <div class="relative mb-3" data-twe-input-wrapper-init>
                <input type="text"
                    ...
                    id="poliklinik" placeholder=" " name="poliklinik" required/>
            ...
            <div class="relative mb-3 mt-2" data-twe-input-wrapper-init>
                ...
                <label for="nama"
                    class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[twe-input-state-active]:-translate-y-[0.9rem] peer-data-[twe-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-400 dark:peer-focus:text-primary">Dokter
                </label>
            </div>&nbsp;
            <div class="relative mb-3 mt-2" data-twe-input-wrapper-init>
                <input type="text"
            ...
            <div class="relative mb-3 mt-2" data-twe-input-wrapper-init>
                ...
                <label for="selasa"
                    class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[twe-input-state-active]:-translate-y-[0.9rem] peer-data-[twe-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-400 dark:peer-focus:text-primary">Selasa
                </label>
            </div>&nbsp;
            <div class="relative mb-3 mt-2" data-twe-input-wrapper-init>
                <input type="text"
            ...
            <div class="relative mb-3 mt-2" data-twe-input-wrapper-init>
                ...
                <label for="jumat"
                    class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[twe-input-state-active]:-translate-y-[0.9rem] peer-data-[twe-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-400 dark:peer-focus:text-primary">Jum'at
                </label>
            </div>&nbsp;
            <div class="relative mb-3 mt-2" data-twe-input-wrapper-init>
                <input type="text"
                ...
                <label for="sabtu"
                    class="pointer-events-none absolute left-3 top-0 mb-0 max-w-[90%] origin-[0_0] truncate pt-[0.37rem] leading-[1.6] text-neutral-500 transition-all duration-200 ease-out peer-focus:-translate-y-[0.9rem] peer-focus:scale-[0.8] peer-focus:text-primary peer-data-[twe-input-state-active]:-translate-y-[0.9rem] peer-data-[twe-input-state-active]:scale-[0.8] motion-reduce:transition-none dark:text-neutral-400 dark:peer-focus:text-primary">Sabtu
                </label>
            </div>&nbsp;
            <button type="submit"
                class="w-full bg-blue-900 text-white py-2 px-4 mb-3 rounded-lg hover:bg-blue-500">Submit</button>
